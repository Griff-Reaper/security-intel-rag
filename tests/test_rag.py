...
class TestDataIngestion:
    ...
    def test_cve_formatting(self):
        ...
        Calls the formatter as a staticmethod so the test does not spin up a
        ChromaDB instance or download the embedding model just to format a dict.
        """
        ...
        formatted = SecurityDataIngester.format_cve_document(test_cve)
